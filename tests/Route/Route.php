...
function testRouteIn(Nette\Routing\IRouter $route, string $url, array $expectedParams = null, string $expectedUrl = null): void
{
...
function testRouteOut(Nette\Routing\IRouter $route, array $params = []): ?string
{
